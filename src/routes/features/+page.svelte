...
<section class="bg-gradient-to-b from-slate-900 to-slate-800 text-white py-20">
	<div class="max-w-4xl mx-auto px-6 text-center">
		...
		<p class="text-slate-400 text-lg max-w-2xl mx-auto">Everything you need to design, visualize, and share professional floor plans — all in your browser, completely free and <a href="https://github.com/sagharborrum/open3dFloorplan" class="text-blue-400 hover:text-blue-300 underline">open source</a>.</p>
	</div>
</section>
